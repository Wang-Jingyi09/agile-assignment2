...
router.get('/tmdb/movies', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$query2, year, rating, page, movies;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _req$query2 = req.query, year = _req$query2.year, rating = _req$query2.rating, page = _req$query2.page;
          _context3.next = 3;
          return (0, _tmdbApi.getMovies)(year, rating, page);
        case 3:
...
router.get('/tmdb/upcoming', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var page, upcomingMovies;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          page = parseInt(req.query.page) || 1; // Get the page number requested, or default to the first page if not specified
          _context5.prev = 1;
          _context5.next = 4;
          return (0, _tmdbApi.getUpcomingMovies)(page);
        case 4:
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          id = req.params.id;
          _context6.next = 3;
          return (0, _tmdbApi.getMovieImages)({
            queryKey: ['images', {
              id: id
            }]
          });
...
router.get('/tmdb/latest', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return (0, _tmdbApi.getLatestMovies)();
        case 2:
          latestMovies = _context7.sent;
...
router.get('/tmdb/movies/:id/recommendations', (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          id = req.params.id;
          _context10.next = 3;
          return (0, _tmdbApi.getMovieRecommendations)(id);
        case 3:
          recommendations = _context10.sent;
